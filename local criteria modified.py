...
# ((planning criteria- Qena planning criteria))
# 1 educational services
if SERVICECODE == "KG": distance = 715  # kindergarten
elif SERVICECODE == "SC1": distance = 753  # Elementary school
elif SERVICECODE == "SC2":  distance = 880  # Preparatory school
elif SERVICECODE == "SC3": distance = 1097  # high school
# 2 health care services
elif SERVICECODE == "AMBC":  distance = 2456  # ambulance station #3500-7000
elif SERVICECODE == "HC":  distance = 1249  # health center
...
elif SERVICECODE == "MSQ": distance = 414  # mosque
elif SERVICECODE == "CHR": distance = 2032  # church    # notice the population
 # 4 fire stations and post office  services (other)
elif SERVICECODE == "FIR": distance = 2880  # fire stations           # sa criteria
elif SERVICECODE == "PST1": distance = 5000  # post office 1
elif SERVICECODE == "PST2":distance = 1504  # post office  2
else:
...
arcpy.MultipleRingBuffer_analysis(INPUTPOINTSERVICE, Output_buffer, [float(distance), float(distance/2)], "Meters", "distance", "ALL", "FULL")
